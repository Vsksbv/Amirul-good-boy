...
╚═╝  ╚═╝╚═╝  ╚═══╝╚═════╝  ╚════╝ ╚══════╝╚═╝  ╚═╝╚═╝  ╚═╝   ╚═╝   
   ...
   \033[1;96m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
   \033[1;93m▇▇➣    \033[1;91mAUTHOR   : 😁😁😁          \033[1;93m▇▇
   \033[1;93m▇▇➣    \033[1;94mGITHUB   : ********            \033[1;93m▇▇
   \033[1;93m▇▇➣    \033[1;93mFACEBOOK : Amirul AndJerry   \033[1;93m▇▇
...
def fuck():
    ...
    print(' [✓] OK Ids saved as AMIRUL-OK.txt')
    print(' [✓] CP Id Save as AMIRUL-CP.txt')
    print('-----------------------------------------------------------')
def hasan(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[AMIRUL]--[%s/%s]--[OK-%s] \r'%(loop,tl,len(oks))),
            sys.stdout.flush()
